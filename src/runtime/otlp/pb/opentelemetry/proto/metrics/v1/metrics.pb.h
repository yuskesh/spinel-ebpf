...
#define opentelemetry_proto_metrics_v1_Metric_init_default {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0, {opentelemetry_proto_metrics_v1_Gauge_init_default}, {{NULL}, NULL}}
...
#define opentelemetry_proto_metrics_v1_Metric_init_zero {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0, {opentelemetry_proto_metrics_v1_Gauge_init_zero}, {{NULL}, NULL}}
...
#define opentelemetry_proto_metrics_v1_Metric_metadata_tag 12
...
#define opentelemetry_proto_metrics_v1_Metric_metadata_MSGTYPE opentelemetry_proto_common_v1_KeyValue
...
#define OPENTELEMETRY_PROTO_METRICS_V1_OPENTELEMETRY_PROTO_METRICS_V1_METRICS_PB_H_MAX_SIZE opentelemetry_proto_metrics_v1_SummaryDataPoint_ValueAtQuantile_size
