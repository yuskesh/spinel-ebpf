...
#define opentelemetry_proto_resource_v1_Resource_init_default {{{NULL}, NULL}, 0, {{NULL}, NULL}}
#define opentelemetry_proto_resource_v1_Resource_init_zero {{{NULL}, NULL}, 0, {{NULL}, NULL}}
...
X(a, CALLBACK, REPEATED, MESSAGE,  entity_refs,       3)
...
#define opentelemetry_proto_resource_v1_Resource_entity_refs_MSGTYPE opentelemetry_proto_common_v1_EntityRef
