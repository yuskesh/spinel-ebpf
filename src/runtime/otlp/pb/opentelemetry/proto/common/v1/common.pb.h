...
#define opentelemetry_proto_common_v1_KeyValue_init_default {{{NULL}, NULL}, false, opentelemetry_proto_common_v1_AnyValue_init_default, 0}
...
#define opentelemetry_proto_common_v1_KeyValue_init_zero {{{NULL}, NULL}, false, opentelemetry_proto_common_v1_AnyValue_init_zero, 0}
...
X(a, STATIC,   ONEOF,    INT32,    (value,string_value_strindex,value.string_value_strindex),   8)
...
X(a, STATIC,   SINGULAR, INT32,    key_strindex,      3)
...
#define opentelemetry_proto_common_v1_EntityRef_FIELDLIST(X, a) \
X(a, CALLBACK, SINGULAR, STRING,   schema_url,        1) \
X(a, CALLBACK, SINGULAR, STRING,   type,              2) \
X(a, CALLBACK, REPEATED, STRING,   id_keys,           3) \
X(a, CALLBACK, REPEATED, STRING,   description_keys,   4)
#define opentelemetry_proto_common_v1_EntityRef_CALLBACK pb_default_field_callback
#define opentelemetry_proto_common_v1_EntityRef_DEFAULT NULL
...
extern const pb_msgdesc_t opentelemetry_proto_common_v1_EntityRef_msg;
...
#define opentelemetry_proto_common_v1_EntityRef_fields &opentelemetry_proto_common_v1_EntityRef_msg
