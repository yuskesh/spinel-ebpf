...
#
# This example uses the pure-XDP TCP slice builtins (tcp_syncookie_gen/_check, tcp_reply_header/_data, payload_starts), which did not survive the move from the
