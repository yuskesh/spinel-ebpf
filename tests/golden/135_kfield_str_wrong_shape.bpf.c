...
// Source unit: 135_kfield_str_wrong_shape.rb
...
} u_135_kfield_str_wrong_shape_top_hits SEC(".maps");
...
static __noinline __s64 kprobe__vfs_read_inner(__s64 file)
{
    ...
    SPNL_KSTR_CHECK(((struct file *)0)->f_path.dentry,
        "kfield_str_eq(file, \"file\", \"f_path.dentry\", \"d_name.name\"): the last field must be characters (char[N] or char *); this chain ends on something else. Note: the LAST string argument is the literal to compare, not a field; a missing literal leaves the chain one hop short.");
    __s64 _ksr2 = SPNL_KFIELD_STR(_ksb1, ((struct file *)0)->f_path.dentry, _ksp2, f_path.dentry);
    __s64 _ksm1 = (_ksr2 == 12);
    _ksm1 = _ksm1 && (_ksb1[0] == 100);
    _ksm1 = _ksm1 && (_ksb1[1] == 95);
    _ksm1 = _ksm1 && (_ksb1[2] == 110);
    _ksm1 = _ksm1 && (_ksb1[3] == 97);
    _ksm1 = _ksm1 && (_ksb1[4] == 109);
    _ksm1 = _ksm1 && (_ksb1[5] == 101);
    _ksm1 = _ksm1 && (_ksb1[6] == 46);
    _ksm1 = _ksm1 && (_ksb1[7] == 110);
    _ksm1 = _ksm1 && (_ksb1[8] == 97);
    _ksm1 = _ksm1 && (_ksb1[9] == 109);
    _ksm1 = _ksm1 && (_ksb1[10] == 101);
    __s64 _if3 = 0;
    if ((_ksm1)) {
        __u32 _k4 = 0;
        __s64 *_p5 = bpf_map_lookup_elem(&u_135_kfield_str_wrong_shape_top_hits, &_k4);
        __u32 _k6 = 0;
        __s64 _v7 = (_p5 ? *_p5 : 0) + 1;
        bpf_map_update_elem(&u_135_kfield_str_wrong_shape_top_hits, &_k6, &_v7, BPF_ANY);
        _if3 = _v7;
    }
    return _if3;
}
